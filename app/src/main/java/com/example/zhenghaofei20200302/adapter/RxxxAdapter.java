 ...
 * 适配器
 */
public class RxxxAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
          Context context;
           List<JsonBean.DataBean.VerticalListDataBean> list;

    public RxxxAdapter(Context context, List<JsonBean.DataBean.VerticalListDataBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        String imageurl = verticalListDataBean.getImageurl();
        String price = verticalListDataBean.getPrice();
